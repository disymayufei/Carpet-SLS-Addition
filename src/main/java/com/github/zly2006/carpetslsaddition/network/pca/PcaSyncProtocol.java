package com.github.zly2006.carpetslsaddition.network.pca;
...
//        ServerMain.LOGGER.debug("Try enablePcaSyncProtocol: {}", player.getName().getString());
...
//        ServerMain.LOGGER.debug("send enablePcaSyncProtocol to {}!", player.getName().getString());
//        lock.lock();
//        lock.unlock();
//    }
//
...
//        ServerMain.LOGGER.debug("send disablePcaSyncProtocol to {}!", player.getName().getString());
//    }
//
//    // 通知客户端更新 Entity
...
//        if (SLSCarpetSettings.pcaSyncProtocol) {
//            ServerMain.LOGGER.debug("onDisconnect remove: {}", serverPlayNetworkHandler.player.getName().getString());
//        }
//    }
//
...
//            return;
//        }
//        ServerMain.LOGGER.debug("{} cancel watch blockEntity.", player.getName().getString());
...
//            return;
//        }
//        ServerMain.LOGGER.debug("{} cancel watch entity.", player.getName().getString());
...
//            }
//        } else if (ServerMain.tisCarpetLoaded && blockState.isOf(Blocks.BARREL) && RuleHelper.getBooleanValue(getCarpetRule("largeBarrel"))) {
...
//                if (SLSCarpetSettings.pcaSyncPlayerEntity == SLSCarpetSettings.PCA_SYNC_PLAYER_ENTITY_OPTIONS.NOBODY) {
//                    return;
//                } else if (SLSCarpetSettings.pcaSyncPlayerEntity == SLSCarpetSettings.PCA_SYNC_PLAYER_ENTITY_OPTIONS.BOT) {
//                    if (!(entity instanceof EntityPlayerMPFake)) {
//                        return;
//                    }
//                } else if (SLSCarpetSettings.pcaSyncPlayerEntity == SLSCarpetSettings.PCA_SYNC_PLAYER_ENTITY_OPTIONS.OPS) {
//                    if (!(entity instanceof EntityPlayerMPFake) && server.getPermissionLevel(player.getGameProfile()) < 2) {
//                        return;
//                    }
//                } else if (SLSCarpetSettings.pcaSyncPlayerEntity == SLSCarpetSettings.PCA_SYNC_PLAYER_ENTITY_OPTIONS.OPS_AND_SELF) {
//                    if (!(entity instanceof EntityPlayerMPFake) &&
//                            server.getPermissionLevel(player.getGameProfile()) < 2 &&
//                            entity != player) {
//                        return;
//                    }
//                } else if (SLSCarpetSettings.pcaSyncPlayerEntity != SLSCarpetSettings.PCA_SYNC_PLAYER_ENTITY_OPTIONS.EVERYONE) {
//                    // wtf????
//                    ServerMain.LOGGER.warn("syncEntityHandler wtf???");
//                    return;
//                }
//            }
//            ServerMain.LOGGER.debug("{} watch entity {}: {}", player.getName().getString(), entityId, entity);
...
//            for (ServerPlayerEntity player : ServerMain.server.getPlayerManager().getPlayerList()) {
